...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr','ExpressionEvaluator.py',30),
  ('expr -> expr MINUS term','expr',3,'p_expr','ExpressionEvaluator.py',31),
  ('expr -> term','expr',1,'p_expr_term','ExpressionEvaluator.py',40),
  ('term -> term TIMES factor','term',3,'p_term','ExpressionEvaluator.py',46),
  ('term -> term DIVIDE factor','term',3,'p_term','ExpressionEvaluator.py',47),
  ('term -> factor','term',1,'p_term_factor','ExpressionEvaluator.py',56),
  ('factor -> NUM','factor',1,'p_factor','ExpressionEvaluator.py',62),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_group','ExpressionEvaluator.py',68),
]
